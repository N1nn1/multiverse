...
public class MultiverseBlocks {
    ...
    public static final Block RAINBOW_WOOL = register("rainbow_wool", new RainbowWoolBlock(FabricBlockSettings.copyOf(Blocks.RED_WOOL).sounds(MultiverseSoundTypes.RAINBOW_WOOL)));
    public static final Block RAINBOW_CARPET = register("rainbow_carpet", new RainbowCarpetBlock(FabricBlockSettings.copyOf(Blocks.RED_CARPET).sounds(MultiverseSoundTypes.RAINBOW_WOOL)));
    public static final Block RAINBOW_BED = register("rainbow_bed", new RainbowBedBlock(FabricBlockSettings.copyOf(Blocks.RED_BED).sounds(MultiverseSoundTypes.RAINBOW_BED)));
