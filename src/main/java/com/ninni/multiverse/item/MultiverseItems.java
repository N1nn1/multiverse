...
public class MultiverseItems {
    ...
    public static final Item DIRTY_STONE_TILE_WALL = register("dirty_stone_tile_wall", new BlockItem(MultiverseBlocks.DIRTY_STONE_TILE_WALL, new FabricItemSettings().group(TAB)));
    ...
    public static final Item SANDY_STONE_TILE_WALL = register("sandy_stone_tile_wall", new BlockItem(MultiverseBlocks.SANDY_STONE_TILE_WALL, new FabricItemSettings().group(TAB)));
