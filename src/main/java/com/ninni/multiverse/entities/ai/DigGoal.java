...
public class DigGoal extends Goal {
    ...
    public boolean canUse() {
        return this.gorb.getRandom().nextInt(2) == 0 && this.gorb.getMainHandItem().isEmpty() && this.gorb.getTarget() == null && this.getNearestPlayer().isEmpty() && this.gorb.getPose() != MultiversePose.HIDDEN.get() && this.gorb.getPose() == Pose.STANDING && this.gorb.isOnGround();
    }
